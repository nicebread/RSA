...
Note that on macos, the use of X11 (including tcltk) requires [XQuartz](https://www.xquartz.org) to be installed manually since it is no longer part of OS X. Always re-install XQuartz when upgrading your macos to a new major version.
...
Not part of this package, but related: you can create polynomial surface plots with this [interactive app](http://shinyapps.org/showapp.php?app=https://tellmi.psy.lmu.de/felix/polySurface):
...
[Sarah Humberg](https://www.uni-muenster.de/PsyIFP/AEBack/members/Sarah_Humberg.html)
